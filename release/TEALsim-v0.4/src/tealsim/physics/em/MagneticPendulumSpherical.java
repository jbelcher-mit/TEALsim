...
public class MagneticPendulumSpherical extends SimEM {
    ...
    public MagneticPendulumSpherical() {
        ...
        super();
        title = "Magnetic Spherical Pendulum";
...
// change some features of the lighting, background color, etc., from the default values, if desired
        ...
        magnet01.setRadius(MagnetRadius);
        magnet01.setMass(.05);
...
//        addElement(magnet01);
 ...
 //      addElement(magnet02);
       ...
       magnet03.setRadius(MagnetRadius);
...
//      addElement(magnet03);
      ...
      magnet04.setRadius(MagnetRadius);
...
//     addElement(magnet04);
     ...
     magnet05.setRadius(MagnetRadius);
 ...
 //   addElement(magnet05);
    ...
    magnet06.setRadius(MagnetRadius);
    magnet06.setMass(1.0);
    magnet06.setMu(-1.*fixedMu);
   ...
   addElement(magnet06);
        ...
        // put field lines on player magnet
        int numberFLA = 5;
        maxStep = 200;
