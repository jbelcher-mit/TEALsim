...
/* Creation date Sun Sep 07 09:15:55 EDT 2025 */
package teal;
...
public class Version {
   ...
   /** buildDate (set during build process to 1757250955935L). */
   private static Date buildDate = new Date(1757250955935L);

   /**
    * Get buildDate (set during build process to Sun Sep 07 09:15:55 EDT 2025).
   ...
   /** buildTimestamp (set during build process to "09/07/2025 09:15 AM"). */
   private static String buildTimestamp = new String("09/07/2025 09:15 AM");

   /**
    * Get buildTimestamp (set during build process to "09/07/2025 09:15 AM").
