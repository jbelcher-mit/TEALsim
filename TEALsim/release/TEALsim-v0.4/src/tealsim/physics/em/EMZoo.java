...
public class EMZoo extends SimEM implements SelectListener {
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        if (pce.getSource() == slider1) {
            if (!fromApplication) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        ((SimEngine)theEngine).requestReorder(pc);
            ...
            Iterator it = selectList.iterator();
            while (it.hasNext()) {
            	((SimEngine)theEngine).requestReorder((HasCollisionController) it.next());
            }
        } else {
...
*/
    ...
    private void resetPointCharges() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            ((SimEngine)theEngine).requestReorder(newCharge);
