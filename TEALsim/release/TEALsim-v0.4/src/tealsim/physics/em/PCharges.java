...
public class PCharges extends SimEM {
    ...
    public PCharges() {
        ...
        mViewer.setNavigationMode(TViewer.ORBIT | TViewer.VP_ZOOM | TViewer.VP_TRANSLATE | TViewer.VP_ROTATE);
        ...
        if(mViewer instanceof TElement) {
        	((TElement)mViewer).addPropertyChangeListener("dragging", this);
        }
        ...
        Collection fls = RelativeFLine.createLines(pc1, teal.field.Field.E_FIELD, 8, false);
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        ...
        if (pce.getSource() == mViewer) {
            if (pc1.isSelected()) ((SimEngine) theEngine).requestReorder(pc1);
            if (pc2.isSelected()) ((SimEngine) theEngine).requestReorder(pc2);
        }
    }
    // This method resets the camera tranform to it's initial state.
    public void resetCamera() {
        mViewer.setLookAt(new Point3d(0.0, 0.0, 1.2), new Point3d(0., 0.0, 0.), new Vector3d(0., 1., 0.));
    }
