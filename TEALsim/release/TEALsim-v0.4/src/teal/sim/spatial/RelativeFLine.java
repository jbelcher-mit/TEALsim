 ...
 * 
 * $Id: RelativeFLine.java,v 1.29 2007/07/17 21:00:54 pbailey Exp $ 
 * 
 */
...
public class RelativeFLine extends FieldLine implements HasReference {
    ...
    public static Collection createLines(Referenced element, int number) {
        return createLines(element, teal.field.Field.E_FIELD, number, false);
    }

    public static Collection createLines(Referenced element, int type, int number) {
        return createLines(element, type, number, false);
    }

    public static Collection createLines(Referenced element, int type, int number, boolean pickable) {
