 ...
 * 
 * $Id: PhysicalObject.java,v 1.94 2007/08/14 20:53:22 pbailey Exp $ 
 * 
 */
...
public class PhysicalObject extends EngineRendered implements PhysicalElement, HasMomentOfInertia, Constrainable,
    ...
    protected HashMap adherenceMap = new HashMap();

    protected Vector3d velocity;
    protected double mass;
    protected transient Vector3d position_d;
    protected transient Vector3d velocity_d;
    /**
     * Position prior to collision.
     */
    protected transient Vector3d position_c;
    /**
     * Velocity prior to collision.
     */
    protected transient Vector3d velocity_c;
    protected transient double mass_d;
    ...
    protected transient double momentOfInertia_d;
    ...
    public PhysicalObject() {
        ...
        mColor = new Color3f(Color.green);
        bounds = null;
        momentOfInertia = 1;
        momentOfInertia_d = 1;
