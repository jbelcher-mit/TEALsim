 ...
 * 
 * $Id: ViewerJ3D.java,v 1.35 2007/08/17 19:38:29 jbelcher Exp $ 
 * 
 */
...
public class ViewerJ3D extends teal.render.viewer.AbstractViewer3D {
    ...
    public ViewerJ3D(boolean useDefaultScene, boolean tryStereo) {
        ...
        //mView.setBackClipDistance(4.0e3);
        
//      Setting the transparency sorting policy to sort by depth improves the look of transparent rendering
        // but causes some unacceptable problems.  Completely counterintuitively, performance is absolutely destroyed
        // when a large number of objects are setDrawn false.
        //mView.setTransparencySortingPolicy(View.TRANSPARENCY_SORT_GEOMETRY);
        //System.out.println("BioChemViewer: calling setWindowResizePolicy()");
        //mView.setWindowResizePolicy(View.VIRTUAL_WORLD);
        //mView.setWindowEyepointPolicy(View.RELATIVE_TO_WINDOW);
        //mView.setDepthBufferFreezeTransparent(false);
