 ...
 * 
 * $Id: RingOfCurrent.java,v 1.40 2008/02/19 19:08:52 pbailey Exp $ 
 * 
 */
...
import teal.render.geometry.Torus;
...
public class RingOfCurrent extends EMObject implements HasRadius, HasCurrent, HasResistance, HasInductance, GeneratesE,
...
/** not sure what this is */
    protected transient double current_d = Teal.RingOfCurrentDefaultCurrent;
/** The resistance of the ring. */
    protected double resistance = Teal.RingOfCurrentDefaultResistance;
/** not sure what this is */
    protected transient double resistance_d = Teal.RingOfCurrentDefaultResistance;
/** The inductance of the ring.  */
    protected double inductance = Teal.RingOfCurrentDefaultInductance;
/** not sure what this is */
    protected transient double inductance_d = Teal.RingOfCurrentDefaultInductance;

    protected transient double radius_d = Teal.RingOfCurrentDefaultRadius;

    protected transient double radial_derivative = 0.;
...
/** Default accurancy for elliptic integral computation. */
    ...
    protected TNode3D makeNode() {
        ...
        node.setGeometry(Torus.makeGeometry(radius, torusRadius, 20, 20));
        ...
        if (mNode != null) {
            if ((renderFlags & GEOMETRY_CHANGE) == GEOMETRY_CHANGE) {
                ...
                if (mNode instanceof TShapeNode) {
                    ...
                    ((TShapeNode) mNode).setGeometry(Torus
                        .makeGeometry((float) (radius), (float) (torusRadius), 20, 20));
                }
 ...
 * @param r The radius. */
    public void setTorusRadius(double r) {
...
/** Checks to see if the ring is inducing or not.  
    ...
    public void getDependentValues(double[] depValues, int offset) {
        ...
        radial_derivative = (radius - radius_d) / ((EMEngine)theEngine).getDeltaTime();
    }
