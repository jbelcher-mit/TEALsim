/* $Id: GaussLawMagDipoleDisk.java,v 1.1 2008/12/23 20:08:16 jbelcher Exp $ */
/**
 * A 
 * 
...
public class MagDipoleFluxThroughDisk extends SimEM {
	...
	public MagDipoleFluxThroughDisk() {
		super();
        ...
        mViewer.setBackgroundColor(new Color(180,180,180));
...
//		visControl.setConvolutionModes(DLIC.DLIC_FLAG_B | DLIC.DLIC_FLAG_BP);
		...
		mViewer.setFogTransformBackScale(0.35);
