/* $Id: Capacitor.java,v 1.6 2007/12/04 21:02:12 pbailey Exp $ */
...
//      Building the world.
        ...
        Collection walls1 = conductor1.getWalls();
        ...
        Collection walls2 = conductor2.getWalls();
        it = walls2.iterator();
        while (it.hasNext()) {
            Wall wall = (Wall) it.next();
            wall.getCollisionController().setTolerance(0.1);
    ...
    public void resetCamera() {
        mViewer.setLookAt(new Point3d(0.0, 0.0, 2.5), new Point3d(), new Vector3d(0., 1., 0.));
