/* $Id: FallingCoil.java,v 1.9 2008/02/11 19:58:09 pbailey Exp $ */
/**
 * A 
 * 
...
public class FallingCoil extends SimEM {
	...
	public FallingCoil() {
		...
		sccx.setRadius(roc.getTorusRadius());
...
//		visControl.setConvolutionModes(DLIC.DLIC_FLAG_B | DLIC.DLIC_FLAG_BP);
		visControl.setConvolutionModes(DLIC.DLIC_FLAG_B);
