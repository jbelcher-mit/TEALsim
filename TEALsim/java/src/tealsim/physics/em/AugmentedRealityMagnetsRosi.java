 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class AugmentedRealityMagnetsRosi extends SimEM {
    ...
    public AugmentedRealityMagnetsRosi() {
...
//        rotatingCoil.setConstrained(true);
        ...
        Quat4d myQuaternion = rotatingCoil.getOrientation();
        System.out.println("Quat4d[x=" + myQuaternion.x + 
                ", y=" + myQuaternion.y + 
                ", z=" + myQuaternion.z + 
                ", w=" + myQuaternion.w + "]");
        
        rotatingCoil.getOrientation();
