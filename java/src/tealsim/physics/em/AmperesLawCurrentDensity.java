...
public class AmperesLawCurrentDensity extends SimEM  {
    ...
    public AmperesLawCurrentDensity() {
        super();
        // Hide run controls       
        mSEC.rebuildPanel(0);
        // Set debug level
   ...
   //     addWall(new Vector3d(0., 0., wheight/2.), new Vector3d(0., length, 0.), new Vector3d( width+length, 0., 0.));
        ...
        // Create the Field Vectors to be used in the scene 
        int numvec = 9;
        ...
        for (int i = 1; i<9; i++) {
	    	...
	    	theField[i].setPosition(new Vector3d(0,0,0));
	 		...
	 		theField[i].setArrowScale(arrowScaleEfield);
