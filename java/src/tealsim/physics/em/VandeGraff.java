/* $Id: VandeGraff.java,v 1.8 2007/12/04 21:02:11 pbailey Exp $ */
...
public class VandeGraff extends SimEM {
	...
	public VandeGraff() {
        ...
        theEngine.setBoundingArea(new BoundingSphere(new Point3d(0., 5., 0.), 16));
        theEngine.setDeltaTime(0.5);
        theEngine.setShowTime(false);
        theEngine.setFrameRate(40.);
        ...
        mViewer.setBounds(20, 20, 450, 450);
    ...
    public void reset() {
        ...
        resetCamera();
        slider.setValue(0.);
        ((SimEngine) theEngine).requestReorder(pointCharge);
        theEngine.requestRefresh();
    }

    public void resetCamera() {
        mViewer.setLookAt(new Point3d(0.0, 0.3, 1.8), new Point3d(0., 0.3, 0.), new Vector3d(0., 1., 0.));
